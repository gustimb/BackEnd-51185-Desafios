        ...
        try {
            ...
            if (cart) {
                ...
                <div>
                    ...
                    <p>Productos: ${newTicket.products.map(product => `<p> • ${product.productName} - Valor: $${product.price} - Cantidad: ${product.quantity} = Valor parcial: $${product.parcialAmount}</p>`).join('')}</p>
                    <hr>
